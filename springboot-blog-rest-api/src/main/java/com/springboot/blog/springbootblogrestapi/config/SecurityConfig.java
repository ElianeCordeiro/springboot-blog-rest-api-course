...
//	//AuthenticationManager will get these users 
//	@Bean
//	public UserDetailsService userDetailsService() {
//		UserDetails eliane = User.builder()
//				.username("eliane")
//				.password(passwordEncoder().encode("eliane"))
//				.roles("USER")
//				.build();
//		
...
//				.build();
//		
//		return new InMemoryUserDetailsManager(eliane, admin);
//						
//	}
